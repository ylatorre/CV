    ...
    <div>
      <div className="WildCodeSchool Wcs">
        <Grid container spacing={0} className="HoLoc">
          <Grid item xs={12} sm={12} md={12} lg={12} xl={12} id="HoLocation" className="ImgHo">
          ...
          <Grid item xs={12} sm={12} md={12} lg={12} xl={12} className=" DescHoLoc">
            <div>
      ...
      <div>
        <Grid container spacing={0} className="HoLoc">
          ...
          <Grid item xs={12} sm={12} md={12} lg={4} xl={4} className="  DescHoLoc">
