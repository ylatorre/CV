...
const WildCodeSchool = () => {
  return (
    <div className="ContainerWildCodeSchool">
      <div className="ContainerTitle Wcs">
        ...
        <div className="ContainerProject">
          <div className="Project">
            <div className="Project_1">
              ...
              <p className="DescProject">Projet: Site internet Portofolio pour un photographe.</p>
          ...
          <div className="Project">
            <div className="Project_2">
              ...
              <p className="DescProject">Projet: Application web type annuaire des ancien élèves de la Wild Code School.</p>
              <p className="ParaProject">
              Persistance de données (mocks et MySQL) Back   Node JS avec une interface CRUD<br/>
                  Front: Javascript / HTMLS CSS / Bootstrap<br/>
                  Fonctionnalités: Inscription et enregistrement de  compte en base  Connexion et déconnexion / Modification de profil / Suppression d compte</p>
            </div>
          </div>
          <div className="Project">
            <div className="Project_3">
              <h4>Réalisation d’un projet plus complexe pour un client.</h4>
              <p className="DescProject">Projet: Application pour l'aasociation "Pour une autre PAC".</p>
              <p className="ParaProject">
              Back: Node JS<br/>
